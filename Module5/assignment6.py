...
data_train, data_test, label_train, label_test = train_test_split(X, y, test_size=0.20, random_state=7)
...
#    Plot2D(T_ISO, "ISO", 1, 2, num_to_plot=40)
...
for K_nb in Ks:
    ...
    knn = KNeighborsClassifier(n_neighbors=K_nb)
    knn.fit(data_train, label_train) 
    accu[K_nb-1] = knn.score(data_test,label_test)
