...
y_train = X['WhiteMale'][X['Year'] < 1986].reshape(-1, 1)
X_test = X['Year'][X['Year'] >= 1986].reshape(-1, 1)
y_test = X['WhiteMale'][X['Year'] >= 1986].reshape(-1, 1)
#
...
#
# .. your code here ..
y_train = X['BlackFemale'][X['Year'] < 1986].reshape(-1, 1)
y_test = X['BlackFemale'][X['Year'] >= 1986].reshape(-1, 1)
model.fit(X_train, y_train)
