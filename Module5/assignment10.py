...
zero = []
for i in range(0,50):
  filename = "Datasets/recordings/0_jackson_" + str(i) + ".wav"
...
#
# .. your code here ..
zero_df = pd.DataFrame(zero, dtype = 'int16')
zero_df = zero_df.dropna(how = "any", axis = 1)
zero = zero_df.values
...
#
# .. your code here ..
Protion_Index = int(Provided_Portion * n_audio_samples)
test = test.reshape(1, -1)
X_train = train[:,:Protion_Index]
y_train = train[:,Protion_Index:]
X_test = test[:,:Protion_Index]
y_test = test[:,Protion_Index:]
