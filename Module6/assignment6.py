...
#
# .. your code here ..
X = X.replace(to_replace=',', value='.', inplace=False, limit=None, regex=True, method='pad', axis=None)
...
#
# .. your code here ..
X[['how_tall_in_meters', 'body_mass_index']] = X[['how_tall_in_meters', 'body_mass_index']].astype(float)
#X = X.drop(X['z4']=='-14420-11-2011 04:50:23.713', axis = 0)
#X = X.drop('index' == 122076, axis = 0)
X['z4'] = X['z4'].astype(int, raise_on_error = True)
#
